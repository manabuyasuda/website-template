...
},{"./util":283}],283:[function(require,module,exports){
"use strict";
 ...
 * </div>
 */
function jsAlignHeight() {
  // 使用するクラス名。
  var baseName = 'js-alignHeight'; // `baseName`+1桁以上の連番。

  var regexp = new RegExp("".concat(baseName, "[0-9]{1,}"));
  var allSelector = document.querySelectorAll("[class*=".concat(baseName, "]"));
  var classNames = []; // 該当する要素のクラス名を`classNames`に格納する。

  Array.prototype.slice.call(allSelector, 0).forEach(function (item) {
    var className = item.className;
    var itemName = className.match(regexp)[0];
    classNames.push(itemName);
  }); // 重複したクラス名を削除する。

  var target = classNames.filter(function (className, i, self) {
    return self.indexOf(className) === i;
  });
  target.forEach(function (className) {
    new _responsiveAutoHeight.default(".".concat(className));
  });
}

;

},{"responsive-auto-height":282}],288:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = jsSmoothScroll;
...
function jsSmoothScroll() {
  var trigger1 = '.js-smoothScroll';
  var trigger2 = 'a[href*="#"]:not([href*="/"]):not(#st-BackToTop)';
  var scroller = new _sweetScroll.default({
    trigger: trigger1,
    // Selector for trigger (must be a valid css selector)
    header: '[data-scroll-header]',
    // Selector or Element for fixed header (Selector of must be a valid css selector)
    duration: 1000,
...
},{"sweet-scroll":285}],289:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = sitewideDialog;
 ...
 * </div>
 */
function sitewideDialog() {
  // ダイアログのID名。1から始まる連番が追加される。
  var dialogName = 'sw-dialog'; // メインコンテンツのID名。ダイアログはこのID要素と兄弟関係になるようにする。

  var container = document.getElementById('main'); // ダイアログを開く直前のスクロール位置。

  var openBeforeLocation = 0;
  generateInstance();
  /**
   * 画面を固定する。
   */
  ...
  function cancelScreenFixed() {
    ...
    (0, _jquery.default)('html, body').scrollTop(openBeforeLocation);
  }
  /**
   * ダイアログのインスタンスを複数生成する。
   */
  ...
  function generateInstance() {
    ...
    for (var i = 0; i < dialogCount; i++) {
      var sequenceDialog = "".concat(dialogName).concat(i + 1);
      var dialog = document.getElementById(sequenceDialog);

      if (dialog) {
        var _sequenceDialog = new _a11yDialog.default(dialog, container); // ダイアログを表示したときの処理


        _sequenceDialog.on('show', function (dialogEl, event) {
          fixScreen();
        }); // ダイアログを非表示にしたときの処理


        _sequenceDialog.on('hide', function (dialogEl, event) {
          cancelScreenFixed();
        });
      }
    }
...
},{"a11y-dialog":2,"jquery":279}],290:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = structureBackToTop;
 ...
 */
function structureBackToTop() {
  var backToTop = new _sweetScroll.default({
    trigger: '#st-BackToTop',
    // Selector for trigger (must be a valid css selector)
    header: '[data-scroll-header]',
    // Selector or Element for fixed header (Selector of must be a valid css selector)
    duration: 1000,
...
},{"sweet-scroll":285}],291:[function(require,module,exports){
"use strict";
...
},{"@babel/polyfill":1,"element-closest":277,"flexibility":278,"picturefill":280,"svg4everybody":284}],292:[function(require,module,exports){
'use strict';
...
var _alignHeight = _interopRequireDefault(require("./namespace/js/alignHeight"));

var _smoothScroll = _interopRequireDefault(require("./namespace/js/smoothScroll"));

var _backToTop = _interopRequireDefault(require("./namespace/structure/backToTop"));

var _dialog = _interopRequireDefault(require("./namespace/sitewide/dialog"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _alignHeight.default)();
(0, _smoothScroll.default)();
(0, _backToTop.default)();
(0, _dialog.default)();

},{"./namespace/js/alignHeight":287,"./namespace/js/smoothScroll":288,"./namespace/sitewide/dialog":289,"./namespace/structure/backToTop":290,"./polyfill":291,"what-input":286}]},{},[292])
